...
<div class="cryptonatorwidget" style="border-radius:4px;padding:10px;' + crypt_calc_style + '">\
    <table width="100%" cellpadding="6">\
		<tr>\
			<td style="width:45%;">\
				<input id="amount-1" type="text" placeholder="введите сумму" style="width:100%;' + crypt_calc_font_style + '">\
			</td>\
			<td style="width:55%;">\
		...
		<tr>\
			<td style="width:45%;">\
				<input id="amount-2" type="text" placeholder="введите сумму" style="width:100%;' + crypt_calc_font_style + '">\
			</td>\
			<td style="width:55%;">\
    ...
    <strong><div style="text-align:center;font-size:30px;opacity:0.6;padding-top:10px;"><a href="faq.html" style="color:' + crypt_calc_font_color + ';" target="_blank"> < < F . A . Q > > </a></div>\
</div></strong>');
...
function loadRates() {
    ...
    var crypt_calc_getPar = eval('(' + httpGet("https://www.cryptonator.com/api/ticker/" +
    ...
    crypt_calc_getPar = eval('(' + httpGet("https://www.cryptonator.com/api/ticker/" +
