...
<div class="cryptonatorwidget" style="border-radius:4px;padding:10px;' + crypt_calc_style + '">\
    ...
    <div style="text-align:center;font-size:30px;opacity:0.6;padding-top:1px;">Created by <a href="http://c-r-y-p-t-x.github.io/" style="color:' + crypt_calc_font_color + ';" target="_blank">F.A.Q</a></div>\
</div>');
